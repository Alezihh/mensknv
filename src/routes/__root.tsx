...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Men's Studio — Ecossistema Premium para o Homem Moderno" },
      {
        property: "og:description",
        content:
          "Mais de 12.000 elementos exclusivos para elevar a sua presença digital com sofisticação.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,600;0,700;1,400&family=Cormorant+Garamond:ital,wght@0,400;0,500;1,400;1,500&family=Inter:wght@300;400;500;600;700&display=swap",
      },
    ],
  }),
      ...
      <body>
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=1060766326546285&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        {children}
